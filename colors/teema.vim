...
if !exists('g:teema_bg')
  let g:teema_bg = '#1d1f23'
  let g:teema_bg_hl = '#1b1d20'
endif
let g:teema_bg_hl = '#1b1d20'

if !exists('g:complcolor')
  let g:complcolor = '#ff7b00'
endif

exec 'hi Normal                      guifg=#c5c5c5           guibg=' . g:teema_bg
exec 'hi NormalNC                    guibg=' . g:teema_bg_hl
exec 'hi VertSplit                   guifg=#2d2f29           guibg=' . g:teema_bg . ' ctermbg=none ctermfg=none gui=none'
exec 'hi NonText                     guifg=' . g:teema_bg . '           guibg=none    gui=none'
...
hi Cursor                      guifg=none              guibg=#9595ff gui=none
hi CursorColumn                guifg=none              guibg=#262626 gui=none
hi CursorLine                  guibg=#292935           gui=none
hi CursorLineNr                guifg=#9595ff           guibg=none    gui=none
...
hi Directory                   guifg=#6970c6           guibg=none    gui=none
...
hi PreCondit                   guifg=#e06061           guibg=none    gui=bold
...
hi Special                     guifg=#C16FE8           guibg=none    gui=none
...
hi Typedef                     guifg=#d26937           gui=none      gui=bold
hi Underlined                  gui=underline
hi Visual                      guifg=none              guibg=#262424 gui=none
hi WildMenu                    guifg=#58d858           guibg=#151515 gui=bold

exec 'hi Pmenu                       guifg=#cfcacf           guibg=#252830 gui=none'
exec 'hi PmenuSel                    guifg=#ffffff guibg=#404040 gui=none'
exec 'hi PmenuSbar                   guifg=#58d858           guibg=#303530 gui=none'
exec 'hi PmenuThumb                  guifg=#58d858           guibg=' . g:complcolor . ' gui=none'
...
hi SignifySignAdd              guifg=#064F0A           guibg=none    gui=none
hi SignifySignChange           guifg=#6F591A           guibg=none    gui=none
hi SignifySignDelete           guifg=#481010           guibg=none    gui=none
...
hi ALEError                    guifg=#ffccdd              guibg=none gui=bold
hi ALEWarning                  guifg=#eecc22              guibg=none gui=none
...
" Nerdtree
hi NERDTreeCurrentNode         guifg=#d977bb           guibg=#403520 gui=none
hi NERDTreeOpenable            guifg=#39376b           guibg=none    gui=none
hi NERDTreeDirSlash            guifg=#39376b           guibg=none    gui=none
hi NERDTreeClosable            guifg=#c0c050           guibg=none    gui=none
hi NERDTreeRO                  guifg=#c0c050           guibg=none    gui=none
hi NERDTreeLinkTarget          guifg=#c0c050           guibg=none    gui=none
hi NERDTreeFile                guifg=#909999           guibg=none    gui=none
